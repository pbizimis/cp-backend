...
def test_generate_stylegan2ada_images(G_model, mocker):
    ...
    mocker.patch("app.stylegan.generation.save_image_as_bytes", side_effect=return_raw_values)
    mocker.patch("app.stylegan.generation.save_vector_as_bytes", side_effect=return_raw_values)
