...
def test_get_stylegan_models_unauthenticated(test_client):
...
def test_get_stylegan_models_authenticated(test_authenticated_client):
    ...
    app.dependency_overrides[stylegan2ada_models] = override_stylegan2_ada_models
