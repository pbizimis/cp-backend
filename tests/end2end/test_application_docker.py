...
# docker run -e MONGO_URL=$MONGO_URL -e MONGO_DB_NAME=$MONGO_DB_NAME -e MONGO_COLLECTION_NAME:$MONGO_COLLECTION_NAME -e AUTH0_DOMAIN=$AUTH0_DOMAIN -e AUTH0_API=$AUTH0_API -e GOOGLE_APPLICATION_CREDENTIALS=/app/testing_credentials.json -e REDIS_URL=$REDIS_URL -e REDIS_RATELIMIT_REQUESTS=100 -e REDIS_RATELIMIT_PERIOD_MINUTES=1 -p 8000:80 api
